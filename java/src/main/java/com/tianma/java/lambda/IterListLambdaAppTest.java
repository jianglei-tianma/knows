package com.tianma.java.lambda;
...
public class IterListLambdaAppTest {
    ...
    public static void main(String[] args) {
        ...
        //lambda表达式
        //List中有一个forEach方法，Consumer接口，循环自己将元素通过accept方法
        // TODO 匿名内部类版
        myList.forEach(
                new Consumer<String>() {
                    @Override
        ...
        myList.forEach(IterListLambdaAppTest::processString);

        // TODO lambda 方法引用终极简化版：不是静态方法，用引用也可以
        IterListLambdaAppTest inst = new IterListLambdaAppTest();
        ...
        // TODO 省略也没问题
        myMap.forEach(IterListLambdaAppTest::processTwoStrings);
